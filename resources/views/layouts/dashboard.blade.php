		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="dark2">
				...
				<a href="index.html" class="navbar-brand">
					{{ config('app.name', 'مرکز فقهی قائم') }}
				</a>
					...
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                                ...
                                <span>
									<h4><i class="fas fa-sort-down"></i>    نام کاربر</h4>
                                    <span class="user-level">مدیر</span>
							...
							<div class="collapse in" id="collapseExample">
								<ul class="nav">
									<li>
										<a href="#profile">
											<span class="link-collapse">اطلاعات کاربری</span>
										</a>
									</li>
									<li>
										<a href="#edit">
											<span class="link-collapse">کار ها</span>
										</a>
									</li>
									<li>
										<a href="#settings">
											<span class="link-collapse">تنظیمات</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="components/avatars.html">
											<span class="sub-item">نوشته جدید</span>
										</a>
									</li>
									<li>
										<a href="components/buttons.html">
											<span class="sub-item">بایگانی نوشته ها</span>
										</a>
									</li>
									<li>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="img/chadengle.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="img/talha.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="img/mlane.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
